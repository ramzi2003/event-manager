        ...
        <div className="px-6 py-8 mx-auto bg-white mt-10 rounded-lg h-[calc(100vh-20px)]">
          ...
          <div className="overflow-y-auto h-[calc(100vh-200px)] no-scrollbar">
            ...
            <div className="mb-8">
              ...
              <div className="text-gray-700 mb-2">{selectedEvent.room}</div>
            </div>
              ...
              <tbody>
                ...
                <tr className="border-b border-gray-200">
                  ...
                  <td className="text-right text-gray-700 py-2">
                    <span className="border border-gray-300 rounded-xl px-3 font-semibold text-sm inline-flex items-center">
                      <GoDotFill className="mr-2 text-red-600" />
                      Someone will come
                    </span><span className="border border-gray-300 rounded-xl px-3 font-semibold text-sm inline-flex items-center">
                      <GoDotFill className="mr-2 text-yellow-500" />
                      Someone
                    </span><span className="border border-gray-300 rounded-xl px-3 font-semibold text-sm inline-flex items-center">
                      <GoDotFill className="mr-2 text-blue-600" />
                      Someone cook the dinner
                    </span>
                  </td>
                </tr>
              </tbody>
